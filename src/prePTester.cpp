...
static void on_trackbar(int, void*) {
    ...
    cv::Mat noWhiteImg;
    cv::inRange(imgTmp, cv::Scalar(no_white_lower, no_white_lower, no_white_lower), cv::Scalar(no_white_upper, no_white_upper, no_white_upper), noWhiteImg);


    

    cv::Mat postMask;
    imgTmp.copyTo(postMask, 255 - noWhiteImg);
